        ...
        <>
            ...
            <section>
                <div className="pagepage position text-center" role="navigation">
                    ...
                    <Link to="/gamesp5.js" className="nextpostslink" rel="next" aria-label="Previous Page">«</Link>
                    ...
                    <span aria-current="page" className="current">6</span>
                    <Link to="/gamesp7.js" className="page larger" title="Page 7">7</Link>
                    <span className="extend">...</span>
                    <Link to="/gamesp7.js" className="nextpostslink" rel="next" aria-label="Next Page">»</Link>
