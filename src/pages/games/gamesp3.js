        ...
        <>
            ...
            <section>
                <div className="pagepage position text-center" role="navigation">
                    ...
                    <Link to="/gamesp2.js" className="nextpostslink" rel="next" aria-label="Previous Page">«</Link>
                    <span className="extend">...</span>
                    <Link to="/games.js" className="page larger" title="Page 1">1</Link>
                    <Link to="/gamesp2.js" className="page larger" title="Page 2">2</Link>
                    <span aria-current="page" className="current">3</span>
                    <Link to="/gamesp4.js" className="page larger" title="Page 4">4</Link>
                    <Link to="/gamesp5.js" className="page larger" title="Page 5">5</Link>
                    <span className="extend">...</span>
                    <Link to="/gamesp4.js" className="nextpostslink" rel="next" aria-label="Next Page">»</Link>
