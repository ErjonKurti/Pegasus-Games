        ...
        <>
            ...
            <section>
                <div className="pagepage position text-center" role="navigation">
                    ...
                    <Link to="/gamesp6.js" className="nextpostslink" rel="next" aria-label="Previous Page">«</Link>
                    ...
                    <span aria-current="page" className="current">7</span>
                    <span className="extend">...</span>
